...
results <- map_dfr(seq(0,0.1,0.005), # beta range
        \(beta){
          realization <- sim_sir(graph_undirected,beta,mu,seeds) # make a realization for each beta
...
First, we identify our best 1% of seeds to find the 1% of seeds that
will most rapidly spread the rumors. In the email settings this would be
represented by a centrality metric. We will use the
